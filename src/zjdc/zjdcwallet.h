...
#ifndef JDCOIN_ZJDCWALLET_H
#define JDCOIN_ZJDCWALLET_H
...
public:
    ...
    void GenerateDeterministicZJDC(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZJDC(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
