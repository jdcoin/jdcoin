...
extern UniValue setzjdcseed(const UniValue& params, bool fHelp);
extern UniValue getzjdcseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzjdc(const UniValue& params, bool fHelp);
extern UniValue dzjdcstate(const UniValue& params, bool fHelp);
