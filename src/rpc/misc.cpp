...
UniValue getinfo(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw std::runtime_error(
            ...
            "  \"zJDCsupply\" :\n"
            "  {\n"
            "     \"1\" : n,            (numeric) supply of 1 zJDC denomination\n"
            "     \"5\" : n,            (numeric) supply of 5 zJDC denomination\n"
            "     \"10\" : n,           (numeric) supply of 10 zJDC denomination\n"
            "     \"50\" : n,           (numeric) supply of 50 zJDC denomination\n"
            "     \"100\" : n,          (numeric) supply of 100 zJDC denomination\n"
            "     \"500\" : n,          (numeric) supply of 500 zJDC denomination\n"
            "     \"1000\" : n,         (numeric) supply of 1000 zJDC denomination\n"
            "     \"5000\" : n,         (numeric) supply of 5000 zJDC denomination\n"
            "     \"total\" : n,        (numeric) The total supply of all zJDC denominations\n"
            "  }\n"
    ...
    UniValue zjdcObj(UniValue::VOBJ);
    for (auto denom : libzerocoin::zerocoinDenomList) {
        if (mapZerocoinSupply.empty())
            zjdcObj.push_back(Pair(std::to_string(denom), ValueFromAmount(0)));
        else
            zjdcObj.push_back(Pair(std::to_string(denom), ValueFromAmount(mapZerocoinSupply.at(denom) * (denom*COIN))));
    }
    zjdcObj.push_back(Pair("total", ValueFromAmount(GetZerocoinSupply())));
    obj.push_back(Pair("zJDCsupply", zjdcObj));
...
UniValue getstakingstatus(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw std::runtime_error(
            ...
            "  \"staking_enabled\": true|false,     (boolean) whether staking is enabled/disabled in jdcoin.conf\n"
            "  \"coldstaking_enabled\": true|false, (boolean) whether cold-staking is enabled/disabled in jdcoin.conf\n"
            "  \"haveconnections\": true|false,     (boolean) whether network connections are present\n"
            "  \"mnsync\": true|false,              (boolean) whether the required masternode/spork data is synced\n"
            "  \"walletunlocked\": true|false,      (boolean) whether the wallet is unlocked\n"
            "  \"stakeablecoins\": n                (numeric) number of stakeable UTXOs\n"
            "  \"stakingbalance\": d                (numeric) JDC value of the stakeable coins (minus reserve balance, if any)\n"
