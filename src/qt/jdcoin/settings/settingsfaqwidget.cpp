// Copyright (c) 2019 The JDCOIN developers
...
SettingsFaqWidget::SettingsFaqWidget(JDCOINGUI *parent) :
    QDialog(parent),
    ui(new Ui::SettingsFaqWidget)
{
    ...
    // Web Link
    ui->pushButtonWebLink->setText("https://JDCOIN.org/");
    ...
    if (parent)
        connect(parent, &JDCOINGUI::windowResizeEvent, this, &SettingsFaqWidget::windowResizeEvent);
}
