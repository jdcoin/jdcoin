...
SendCustomFeeDialog::SendCustomFeeDialog(JDCOINGUI* parent, WalletModel* model) :
    QDialog(parent),
    ...
    walletModel(model)
{
    ...
    if (parent)
        connect(parent, &JDCOINGUI::themeChanged, this, &SendCustomFeeDialog::onChangeTheme);
