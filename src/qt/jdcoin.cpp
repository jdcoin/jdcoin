...
void BitcoinApplication::createWindow(const NetworkStyle* networkStyle)
{
    ...
    connect(pollShutdownTimer, &QTimer::timeout, window, &JDCOINGUI::detectShutdown);
...
void BitcoinApplication::startThread()
{
    ...
    connect(window, &JDCOINGUI::requestedRestart, executor, &BitcoinCore::restart);
...
void BitcoinApplication::initializeResult(int retval)
{
    ...
    if (retval) {
        ...
        //connect(paymentServer, &PaymentServer::receivedPaymentRequest, window, &JDCOINGUI::handlePaymentRequest);
        connect(window, &JDCOINGUI::receivedURI, paymentServer, &PaymentServer::handleURIOrFile);
