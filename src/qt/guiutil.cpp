...
QString formatBalance(CAmount amount, int nDisplayUnit, bool isZjdc)
{
    return (amount == 0) ? ("0.00 " + BitcoinUnits::name(nDisplayUnit, isZjdc)) : BitcoinUnits::floorHtmlWithUnit(nDisplayUnit, amount, false, BitcoinUnits::separatorAlways, true, isZjdc);
}
