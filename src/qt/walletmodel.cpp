...
bool WalletModel::createZjdcSpend(
        CWalletTx &wtxNew,
...
bool WalletModel::convertBackZjdc(
        CAmount value,
        std::vector<CZerocoinMint> &vMintsSelected,
        CZerocoinSpendReceipt &receipt)
{
...
static void NotifyzJDCReset(WalletModel* walletmodel)
{
    qDebug() << "NotifyzJDCReset";
...
void WalletModel::subscribeToCoreSignals()
{
    ...
    wallet->NotifyzJDCReset.connect(boost::bind(NotifyzJDCReset, this));
...
void WalletModel::unsubscribeFromCoreSignals()
{
    ...
    wallet->NotifyzJDCReset.disconnect(boost::bind(NotifyzJDCReset, this));
...
{
    setMints.clear();
    setMints = pwalletMain->zjdcTracker->ListMints(fUnusedOnly, fMaturedOnly, fUpdateStatus, fWrongSeed);
}
