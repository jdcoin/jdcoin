...
"""Verify that starting jdcoin with -h works as expected."""
import subprocess

from test_framework.test_framework import JdcoinTestFramework
from test_framework.util import assert_equal

class HelpTest(JdcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start jdcoin with -h for help text")
        ...
        self.log.info("Start jdcoin with -version for version information")
